...
export const LocationsList = () => {
  ...
  function details(index: number, location?: Location) {
    return (
  ...
  const rows = locations.map((location, index) => {
    ...
    return (
      <React.Fragment key={String(location.id)}>
        ...
        {current && details(index, location)}
      </React.Fragment>
    );
  });

  return (
    <ListTemplate type="location" path="/locations" title="Locations">
      ...
      <Table>
        ...
        <TableBody>
          ...
          {id === NEWID && details(Number.MIN_SAFE_INTEGER, undefined)}
          {rows}
        </TableBody>
      </Table>
    </ListTemplate>
