...
const currentResource = (unit: DashboardUnit) => {
  switch (unit) {
    case DashboardUnit.day:
      return "flightsByDays";
    case DashboardUnit.month:
      return "flightsByMonths";
    case DashboardUnit.year:
      return "flightsByYears";
  }
};
      ...
      <Card>
        ...
        <CardContent>
          ...
          <Select
            value={unit}
            onChange={(e) => {
              const newUnit = e.target.value as DashboardUnit;
              setUnit(newUnit);
